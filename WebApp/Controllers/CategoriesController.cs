...
namespace WebApp.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController()
        {
            ...
            ProductApiUrl = "https://localhost:5001/api/Categories";
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            List<Category> list = JsonSerializer.Deserialize<List<Category>>(stringData, options);
            return View(list);
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            try
            {
                ...
                HttpResponseMessage productResponse = await client.GetAsync($"https://localhost:5001/api/Categories/{id}");
                ...
                if (productResponse.IsSuccessStatusCode)
                {
                    ...
                    Category cat = JsonSerializer.Deserialize<Category>(productData, options);
                    return View(cat);
        ...
        public async Task<IActionResult> Create(Category cat)
        {
            ...
            {
                var content = new StringContent(JsonSerializer.Serialize(cat), Encoding.UTF8, "application/json");
        ...
        public async Task<IActionResult> Edit(int id, [Bind("CategoryId, CategoryName")] Category cat)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    // Handle errors
                    ModelState.AddModelError(string.Empty, "Error updating the cat.");
                }
            }
            return View(cat);
        }
